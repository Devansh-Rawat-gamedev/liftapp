...
class NotificationService extends GetxService {
  ...
  Future<void> requestPermission() async {
    ...
    if (settings.authorizationStatus == AuthorizationStatus.denied) {
      MyLoaders.warningSnackBar(title: 'No Permission', message: "Notification permissions denied.");
      //TCrashlyticsHelper.recordError('Notification permissions denied');
    } else if (settings.authorizationStatus == AuthorizationStatus.notDetermined) {
      MyLoaders.warningSnackBar(title: 'No Permission', message: "Notification permissions not determined.");
